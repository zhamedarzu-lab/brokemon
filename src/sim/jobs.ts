...
export const EMPLOYMENT: Record<EmploymentId, EmploymentDef> = {
  martClerk: {
    ...
    cost: { energy: -22, hygiene: -8, hunger: -16, thirst: -20, morale: -2 },
    exertion: 1.2,
    salaried: false,
  ...
  nightStock: {
    ...
    grace: 1,
    pay: 68,
    requires: { hygiene: 30, energy: 30 },
    cost: { energy: -46, hygiene: -14, hunger: -20, thirst: -22, morale: -8 },
    exertion: 2.0,
    salaried: false,
    desc: "Nobody sees you, nobody smells you, and it pays better than daylight.",
  },
  landscaper: {
    id: "landscaper",
    name: "Grounds Crew",
    ...
    grace: 0.5,
    pay: 74,
    requires: { hygiene: 30, energy: 35, experience: { job: "martClerk", shifts: 0 } },
    cost: { energy: -44, hygiene: -26, hunger: -26, thirst: -34, morale: +2 },
    exertion: 2.4,
    salaried: false,
  ...
  technician: {
    ...
    cost: { energy: -34, hygiene: -14, hunger: -22, thirst: -26 },
    exertion: 1.5,
    salaried: true,
  ...
  officeAdmin: {
    ...
    cost: { energy: -26, hygiene: -6, hunger: -20, thirst: -24, morale: +1 },
    exertion: 1.0,
    salaried: true,
  ...
  executive: {
    ...
    cost: { energy: -22, hunger: -18, thirst: -22, morale: +4 },
    exertion: 0.8,
    salaried: true,
